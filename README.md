...
本次测试选取10个典型端侧问题，包括语音指令控制、英翻中、个人私密、应急处置建议、敏感信息处理、军事问答决策、离线网络攻击代码、个人写作、感情互动和长上下文理解4K，从测评结果综合看，当前Qwen3-1.7B是较佳选择，各方能力都还不错，但是这个模型安全对齐较为严格，军事问答决策、离线网络攻击代码等这类问题屏蔽不答。

（按照评测时间排序，其中one-ELO只是进行了一轮对比评估，结果仅供参考）：

模型名称| 参数量 |量化尺度 | 发布时间 | 发布机构 | 能力域 | 安全对齐 | one-ELO  
-|-|-|-|-|-|-|-
Hunyuan-1.8B-Instruct | 1.8B | 4Bit | 2025-08-04 | Tencent | 混合 | 适中 | 1528
Qwen3-1.7B | 1.7B | 4Bit | 2025-08-06 | Qwen | 混合 | 严格 | 1528
Qwen3-0.6B | 0.6B | bf16 | 2025-08-06 | Qwen | 混合 | 严格 |1288
gemma-3-270m-it | 270M | bf16 | 2025-08-15 | Google | 非推理 | 宽松 | 1096
